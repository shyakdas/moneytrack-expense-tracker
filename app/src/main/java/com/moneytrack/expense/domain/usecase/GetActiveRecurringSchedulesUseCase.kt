...
class GetActiveRecurringSchedulesUseCase @Inject constructor(
    private val expenseRepository: ExpenseRepository,
) {
    suspend operator fun invoke(): List<RecurringExpenseSchedule> =
        expenseRepository.getActiveRecurringSchedules()
}
